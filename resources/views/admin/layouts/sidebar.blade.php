    ...
    <div class="data-scrollbar" data-scroll="1">
        <nav class="iq-sidebar-menu">
            <ul id="iq-sidebar-toggle" class="iq-menu">
                <li class="active">
                    <a href="{{ route('dash') }}" class="svg-icon">
                ...
                <li class=" ">
                    ...
                    <ul id="purchase" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                            <li class="">
                                    <a href="{{ route('list_purchases') }}">
                                        <i class="las la-minus"></i><span>List Purchases</span>
                                    </a>
                            </li>
                            <li class="">
                                    <a href="{{ route('add_purchases') }}">
                ...
                <li class=" ">
                    ...
                    <ul id="return" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                            <li class="">
                                    <a href="{{ route('list_returns') }}">
                                        <i class="las la-minus"></i><span>List Returns</span>
                                    </a>
                            </li>
                            <li class="">
                                    <a href="{{ route('add_returns') }}">
                ...
                <li class=" ">
                    <a href="#people" class="collapsed" data-toggle="collapse" aria-expanded="false">
                        ...
                        <span class="ml-4">View Orders</span>
